...
while True:
    print("1 to add new product to inventory")
    ...
    if op == 1:
        ...
        Products.all_products[index].deleteItem()
...
# Remaining from import abc and remember to sir to change code for generate barcode and delete item like trial.py
